...
```
    ...
    Plotted profile 1 to:
     results/escape_profiles/LY_cocktail_stackedlogo.pdf
     results/escape_profiles/LY_cocktail_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_1.png)
    ...
    Plotted profile 2 to:
     results/escape_profiles/LY_cocktail_color_by_bind_stackedlogo.pdf
     results/escape_profiles/LY_cocktail_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_3.png)
    ...
    Plotted profile 3 to:
     results/escape_profiles/LY_cocktail_color_by_expr_stackedlogo.pdf
     results/escape_profiles/LY_cocktail_color_by_expr_stackedlogo.png.
